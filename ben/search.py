...
def process_query(query, field_type):
    ...
    tmp = "".join([char  if char.isascii() is False or char in string.digits else ' ' for char in query]).strip().split()
    queries = tmp
    # print("Query: ", query)
    # print(parsed_tokens)
    # print(field_type)
...
def find_tfidf_postings(query_token):
    ...
    file_to_find = "out_mal/"+file_to_find
    # print("///////////////////////////////")
    # print(query_token)
    st = timer()
...
if __name__ == "__main__":
    ...
    # print(timedelta(seconds=end-start), file=queries_op)
